 ...
 * @private
 */
Action.Asynchronous_Action.prototype._each_watcher_NEW = function( f )
{
...
Action.Join_class.prototype.condition_good = function()
{
  this.end_well();
};
Action.Join_class.prototype.condition_bad = function( e )
{
  this.end_badly( e );
};
...
{
  this.join_action.condition_good();
};
Action.JC_Wait.prototype.bad = function()
{
  this.join_action.condition_bad();
};
