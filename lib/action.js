 ...
 */
Action.Asynchronous_Action.prototype.go = function( finisher, catch_f )
{
...
/**
 * Change state to Exception and execute the catch function followed by the finisher.
 *
 * @protected
 * @param e
 *    An exception value
...
/**
 * Terminate this timer without prejudice. The finisher will run as always.
 */
