 ...
 * @param return_value
 */
Action.Asynchronous_Action.prototype.end_well = function( return_value )
{
  function good()
  {
  ...
  if ( this.finisher ) this.finisher.apply( null, return_value );
};
...
{
  Action.Join_class.prototype._go.call( this );
  if ( !this.completed )
  {
