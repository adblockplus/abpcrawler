...
Action.Watcher_interface.prototype.notice_good = function( id )
{
};
Action.Watcher_interface.prototype.notice_bad = function( id, e )
{
};
...
Action.JC_Wait.prototype.notice_good = function()
{
  this.join_action.notice_good( null );
};
Action.JC_Wait.prototype.notice_bad = function( id, e )
{
  this.join_action.notice_bad( id, e );
};
...
Action.Join_Conjunction.prototype.notice_bad = function( id, e )
{
};
