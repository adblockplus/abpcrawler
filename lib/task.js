 ...
 *
 */
var Long_Task = exports.Long_Task = function( task_generator, may_pause, runaway_limit )
{
    /**
...
/**
 * Dispatch a function of our own class.
 * <p/>
 * Only nullary functions right now. Could bind additional arguments if needed.
 *
 * @param own_function
 */
Long_Task.prototype.dispatch = function( own_function )
{
    var runnable = {
        run: own_function.bind( this )
    };
    this.thread_manager.currentThread.dispatch( runnable, Ci.nsIEventTarget.DISPATCH_NORMAL );
};
