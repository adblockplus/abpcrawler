 ...
 */
Long_Task.prototype.run = function( finally_f, catch_f )
{
...
Long_Task.prototype._run_once = function()
{
     ...
     * pending.
     */
    this.dispatch( this._run_once.bind( this ) );
    /*
 ...
 * the iteration.
 */
Long_Task.prototype.dispatch = function( f )
{
