 ...
 */
var Crawler = function( instructions, outputs, window, leave_open, number_of_tabs )
{
  /**
  ...
  try
  {
    ...
    for ( instruction of gen )
    {
      ...
      if ( this.tabbed_browser.available() )
      {
         ...
         */
        tab = this.tabbed_browser.make_tab( instruction.target, this.leave_open );
         ...
         */
        tab.load().go( this._land.bind( this, tab, resume ), null );
