 ...
 * @param success
 */
Crawler.prototype._land = function( tab, resume, success )
{
    Utils.runAsync( this._load_end_action, this, tab, resume, success );
};
...
Crawler.prototype.node_action = function( original_f, wnd, node, contentType, location, collapse )
{
    ...
    try
    {
        ...
        log( "Observation: {content_type:" + Policy.typeDescr[contentType]
            + ", n_entries:" + entries.length + ", location:" + url_location + "}" );
