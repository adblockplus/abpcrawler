...
Crawler.prototype._load_end_action = function( tab, resume )
{
   ...
   * then the tab action completed. In all cases, the tab will be complete afterwards. Note that although the tab load
   * action will be complete, it may not have written the instruction results yet, since that operation may have been
   * deferred.
   */
