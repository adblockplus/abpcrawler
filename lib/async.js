...
{
  /**
   * Timer actions always complete, even if cancelled or aborted early.
   * @const
   * @type {boolean}
   */
  this.reliable = true;
};
Async.Timer_class.prototype = new Async.Asynchronous_Action();
 ...
 * @param duration
 */
Async.Timer_class.init = function( f, duration )
{
  Async.Asynchronous_Action.init.call( this );
  this.try_f = f;
...
Async.Timer_class.prototype._go = function()
{
  this.timer_id = Async_Platform.set_timer( this._body.bind( this ), this.duration );
};

Async.Timer_class.prototype._body = function()
{
  try
  {
    if ( this.try_f ) this.try_f();
 ...
 */
Async.Timer_class.prototype.cancel = function()
{
};
 ...
 * Terminate a c
 */
Async.Timer_class.prototype.abort = function()
{
};


Async.Timer = function( f, duration )
{
  Async.Timer_class.init.call( this, f, duration );
};
Async.Timer.prototype = new Async.Timer_class();
