 ...
 */
Browser_Tab.prototype.load = function()
{
 ...
 */
Browser_Tab.prototype._show = function()
{
  ...
  catch ( e )
  {
    ...
    if ( this.finisher ) this.finisher( false, undefined );
  }
};
...
Browser_Tab.prototype._stop = function( stop_status )
{
  ...
  if ( this.finisher ) this.finisher( success, this.error_code );
};
