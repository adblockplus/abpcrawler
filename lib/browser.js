...
Browser_Tab.prototype._show = function( target )
{
    ...
    try
    {
        ...
        this.tab.addEventListener( "TabClose", this._tab_closed.bind( this ) );
    }
    catch ( e )
    {
        ...
        if ( this.finally_f ) this.finally_f( false, undefined );
    }
};
...
Browser_Tab.prototype._stop = function( stop_status )
{
     ...
     * means that we need the state in this Browser_Tab instance. The choice is to make a call back to the parent
     * instead of exposing this object's internal state.
     */
