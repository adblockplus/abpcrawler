...
var Tabbed_Browser = exports.Tabbed_Browser = function( window, max_requests )
{
     ...
     * @type {WeakMap}
     */
    this.map_brower_to_child = new WeakMap();
...
Tabbed_Browser.prototype.notify_load_begin = function( child )
{
    ...
    var value = { child: child };
    value.prototype = this.map_range_prototype;
    this.map_brower_to_child.set( child.browser, value );
};
...
{
    if ( this.map_brower_to_child.has( child.browser ) )
    {
        this.map_brower_to_child.delete( child.browser );
    }
    else
    {
...
Browser_Tab.prototype.load = function( target )
{
    ...
    {
        // This is a stopgap. The caller should be calling available() on the Tabbed_Browser first.
        return null;
    }
    return {
