...
YAML_stream.prototype.write = function( value, view )
{
     ...
     */
    this.push_state( new YAML_state( view, {value: value} ) );
    this.push_format( 0, "", "" );
    var g = this._machine();
    this.generator = g;
    try
        ...
        switch ( view.type.id )
        {
            ...
            case Encoding.type.object.id:
                ...
                for ( let i = 0 ; i < view.seq.length ; ++i )
                {
                    ...
                    this.push_state( new YAML_state( null ) );
                }
                break;
            ...
            case Encoding.type.array_stream.id:
            {
                ...
                this.push_state( new YAML_state( view.element_view ) );
                ++context.state.i;
                /*
                ...
                if ( is_initial_pass )
                {
                     ...
                     */
                    this.push_format( 0, "", "" );
                    this.push_state( new YAML_state( { type: Encoding.type.start } ) );
