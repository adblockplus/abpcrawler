...
YAML_stream.prototype.sequence_start = function( value )
{
    ...
    while ( this.stack_is_nonempty() )
    {
        ...
        switch ( view.type.id )
        {
            ...
            case Encoding.type.stop.id:
                ...
                /*
                 * First pop the fram for what would have been the next array entry. Then pop the array frame itself,
