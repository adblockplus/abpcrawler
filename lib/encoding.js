...
YAML_stream.prototype._machine = function()
{
    while ( this.has_token() )
    {
        ...
        if ( "token" in context )
        {
            var received_token = context.token;
        }
        else
        {
            received_token = yield null;
        }
        /*
         ...
         */
        if ( "value" in received_token )
        {
            var value = received_token.value;
        }
        else
        {
            /*
             ...
             */
            value = undefined;
            log( "Received mark = " + JSON.stringify( received_token.mark )
                + "\nold view = " + JSON.stringify( view ) );
            view = { type: received_token.mark };
            /*
