...
Instruction_class.prototype.begin = function()
{
    ...
    var test_object = {
        ...
        "courtesy-of": "Encoding.Format_stream"
    };
    this.storage.write( "# begin test\n" );
    this.storage.write( "# test object = " + JSON.stringify( test_object ) + "\n" );
    var y = new Encoding.Format_stream( this.storage.writer(), Encoding.YAML );
    y.write( test_object );
    this.storage.write( "# end test\n" );
 ...
 * @param storage
 */
Instruction_Set.Basic = function( browse_list, storage )
{
...
Instruction_Set.Basic.prototype.__encoding__ =
    Encoding.as_object( [Encoding.immediate_fields( ["storage"] )] );
...
Instruction_Set.Basic.prototype.generator = function()
{
    ...
    for ( let j = 0 ; j < n ; ++j )
    {
        yield new Default_Instruction( this.browse_list[j], this.storage );
    }
};
